            ...
            <div className='flex flex-col ml-[30px] gap-[20px]'>
              ...
              {product.stock > 0 ? (
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#133E87] rounded-[15px] text-center text-white active:bg-[#4956ab]"
                  >
                ...
                <p className="max-w-[500px]   whitespace-pre-line">
