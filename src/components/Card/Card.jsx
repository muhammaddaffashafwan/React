...
export default function Card({product}) {
  return (
    <Link to={`/products/${product.slug}` ?? ''} className="flex flex-col max-w-[370px] flex-wrap rounded-[20px] p-[16px] bg-[#608BC1] shadow-xl hover:ring-opacity-80 active:ring-5 hover:ring-[#133E87] active:ring-[#6247eb] hover:ring-4 active:ring-2 active:ring-opacity-90" >
    <div className="flex flex-col max-w-[370px]  flex-wrap p-[16px] bg-[#608BC1]" >
                ...
                {product.stock <= 0 ? (
                    ...
                    <>
                       <p className="text-xl font-semibold text-center text-yellow-500">Almost Sold Out</p>
                        <Button type="button" className="inline-flex items-center justify-center gap-2 p-4  text-center rounded-[15px]  text-white bg-[#133E87]">
